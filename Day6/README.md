...
Practice Questions
What is the difference between ML (Day 5) and Generative AI?
What does temperature=0.0 do? When would you use it?
Write a few-shot prompt to extract name and salary from text as JSON.
What is LLM hallucination? How does prompt engineering reduce it?
LLM returns ```json\n{"name":"Ramesh"}\n``` and json.loads() crashes. Write the fix.
How does today's Smart Data Cleaner differ from manual Day 3 ETL?
